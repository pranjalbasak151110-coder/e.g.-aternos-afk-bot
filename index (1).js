...
function validateSettings() {
  if (!settings.server.host || settings.server.host === 'your-server.aternos.me') {
    logger.error('settings.json is not configured: "server.host" is still the placeholder value.')
    logger.error('Edit settings.json and set server.host to your actual server address before starting the bot.')
    process.exit(1)
  }
}
